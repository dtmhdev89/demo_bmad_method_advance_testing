...
- generic [active] [ref=e1]:
  - button "Open Next.js Dev Tools" [ref=e7] [cursor=pointer]:
    - img [ref=e8]
  - alert [ref=e11]: Xác thực | Polyglot Cards
  - generic [ref=e14]:
    - link "Polyglot Cards" [ref=e16] [cursor=pointer]:
      - /url: /en
      - generic [ref=e18]: Polyglot Cards
    - generic [ref=e20]:
      - heading "Đăng nhập" [level=1] [ref=e21]
      - paragraph [ref=e22]: Tiếp tục hành trình chinh phục ngôn ngữ
      - generic [ref=e23]:
        - generic [ref=e24]:
        ...
        - generic [ref=e27]:
          ...
          - textbox "Mật khẩu" [ref=e31]:
            - /placeholder: ••••••••
        - button "Đăng nhập ngay" [ref=e32]
      - generic [ref=e35]: hoặc
      - paragraph [ref=e37]:
        - text: Chưa có tài khoản?
        - link "Đăng ký miễn phí" [ref=e38] [cursor=pointer]:
          - /url: /en/register
```
